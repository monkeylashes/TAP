...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class BodyNetworkObject : NetworkObject
	{
		...
		public override void InterpolateUpdate()
		{
			...
			if (scaleInterpolation.Enabled && !scaleInterpolation.current.Near(scaleInterpolation.target, 0.0015f))
			{
		...
		public BodyNetworkObject() : base() { Initialize(); }
		public BodyNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0) : base(networker, networkBehavior, createCode) { Initialize(); }
		public BodyNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
